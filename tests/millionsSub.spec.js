...
describe('5000000-25000000', function () {
    this.timeout(30000);
    let driver;
    let vars;
    ...
    it('5000000-25000000', async function () {
        await driver.get("http://127.0.0.1:8000/index.html")
        await driver.manage().window().setRect({ width: 720, height: 900 });

        await driver.findElement(By.id("num1")).click();
        await driver.findElement(By.id("num1")).sendKeys("5000000");

        await driver.findElement(By.id("num2")).click();
        await driver.findElement(By.id("num2")).sendKeys("2500000");
